...
Bsupply: main.o getorbit.o getfields.o getspectrum.o gamma.o exportfile.o madximport.o ELSAimport.o metadata.o
	g++ $(cflags) -lgsl -lgslcblas -lm -o Bsupply main.o getorbit.o getfields.o getspectrum.o gamma.o exportfile.o madximport.o ELSAimport.o metadata.o
...
getfields.o: getfields.cpp constants.hpp types.hpp gamma.hpp
	g++ $(cflags) -c getfields.cpp
getspectrum.o: getspectrum.cpp constants.hpp types.hpp
	g++ $(cflags) -c getspectrum.cpp
gamma.o: gamma.cpp constants.hpp
	g++ $(cflags) -c gamma.cpp
...
clean: 
	rm Bsupply main.o getorbit.o getfields.o getspectrum.o gamma.o exportfile.o madximport.o ELSAimport.o metadata.o
