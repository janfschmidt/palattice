...
Bsupply: main.o getorbit.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o fieldmap.o spectrum.o
	g++ $(cflags) -o Bsupply main.o getorbit.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o fieldmap.o spectrum.o -lgsl -lgslcblas -lm

main.o: main.cpp constants.hpp types.hpp fieldmap.hpp spectrum.hpp getorbit.hpp getfields.hpp exportfile.hpp madximport.hpp metadata.hpp difference.hpp timetag.hpp filenames.hpp resonances.hpp
	g++ $(cflags) -c main.cpp
...
difference.o: difference.cpp constants.hpp types.hpp ELSAimport.hpp fieldmap.hpp spectrum.hpp
...
clean: 
	rm Bsupply main.o getorbit.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o fieldmap.o spectrum.o strom2kick new_strom2kick
