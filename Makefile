...
clean: 
	rm Bsupply main.o getfields.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o spectrum.o interpolate.o functionofpos.o field.o strom2kick new_strom2kick
