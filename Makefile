...
Bsupply: main.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o spectrum.o interpolate.o field.o
	g++ $(cflags) -o Bsupply main.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o spectrum.o interpolate.o field.o -lgsl -lgslcblas -lm

main.o: main.cpp constants.hpp types.hpp spectrum.hpp getfields.hpp exportfile.hpp madximport.hpp metadata.hpp difference.hpp timetag.hpp filenames.hpp resonances.hpp interpolate.hpp interpolate.hxx functionofpos.hpp functionofpos.hxx field.hpp
	g++ $(cflags) -c main.cpp
...
clean: 
	rm Bsupply main.o getfields.o getspectrum.o exportfile.o madximport.o ELSAimport.o metadata.o difference.o timetag.o filenames.o resonances.o spectrum.o interpolate.o field.o strom2kick new_strom2kick
